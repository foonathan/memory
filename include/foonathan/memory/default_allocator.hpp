...
{
    /// The default \concept{concept_rawallocator,RawAllocator} that will be used as block allocator in memory arenas.
    /// Arena allocators like \ref memory_stack or \ref memory_pool allocate memory by subdividing a huge block.
    /// They get a block allocator that will be used for their internal allocation,
